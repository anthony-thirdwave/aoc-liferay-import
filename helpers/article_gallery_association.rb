...
def create_rotator(objects)
  image_store = "./assets/2016_issues/www.chicagocatholic.com/#{objects.first.class}_images"
  FileUtils.rmtree("#{image_store}")
  FileUtils.mkdir("#{image_store}")
  objects.each do |object|
    new_loc = "#{image_store}/#{object.file.split("/").last}-#{object.id}"
    pwd = "/Users/anthony.surganov/Documents/LifeRay/aoc-liferay-import/assets/2016_issues/"
